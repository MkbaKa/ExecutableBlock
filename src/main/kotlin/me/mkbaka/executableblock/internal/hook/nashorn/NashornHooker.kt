...
import me.mkbaka.executableblock.internal.hook.nashorn.impl.LegacyNashornHookerImpl
import me.mkbaka.executableblock.internal.hook.nashorn.impl.NashornHookerImpl
...
abstract class NashornHooker {
     ...
     * @return 返回值
     */
    abstract fun invoke(compiledScript: me.mkbaka.executableblock.internal.hook.nashorn.CompiledScript, function: String, map: Map<String, Any>?, vararg args: Any): Any?
